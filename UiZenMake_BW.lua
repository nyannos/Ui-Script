...
-- ========================================
-- MINIMIZE ICON (black & white) - rbxassetid://94678517792779
-- ========================================
do
  ...
  local function ToggleMenu()
    ...
    pcall(function()
      if UI then UI.Enabled = menuVisible end
    end)
    -- spin
    pcall(function()
      local goal = btn.Rotation + (menuVisible and 360 or -360)
      local tw = TweenService:Create(btn, TweenInfo.new(0.35, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Rotation = goal})
      tw:Play()
      tw.Completed:Wait()
...
Title.Text = "nyann os Version 5".."<font color='rgb(220, 220, 220)'> by real_@nyannnokonoko</font>".." | "..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
Title.RichText = true;
...
UIGradient.Color = ColorSequence.new {
  ColorSequenceKeypoint.new(0.00, Color3.fromRGB(30,30,30)), ColorSequenceKeypoint.new(0.29, Color3.fromRGB(200, 200, 200)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(200, 200, 200)), ColorSequenceKeypoint.new(0.68, Color3.fromRGB(160, 160, 160)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(30,30,30))}
...
LineHealth.BackgroundColor3 = Color3.fromRGB(230, 230, 230)
